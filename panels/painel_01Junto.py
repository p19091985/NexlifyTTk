# panels/painel_01Junto.py (Versão Corrigida e Robusta)
...
class PainelVisualizacaoDadosJunto(BasePanel):
    PANEL_NAME = "Gestão - Arquivo Junto"
    PANEL_ICON = "🔗"
    ...
    def _create_form_widgets(self, parent):
        ...
        self.add_tipo_button = ttk.Button(tipo_frame, text="➕", command=self._open_tipos_modal,
        ...
        self.clear_button = ttk.Button(btn_frame, text="Limpar", command=self._clear_form, style="secondary.TButton")
    ...
    def _create_legacy_action_buttons(self, parent):
        reclassify_btn = ttk.Button(parent, text="Reclassificar C++ para 'Legado' (Exemplo Atômico)",
                                    command=self._executar_reclassificacao, style="info.Outline.TButton")
    ...
    def _carregar_tipos_linguagem(self):
        try:
            ...
            self.tipo_combobox['values'] = novos_valores
