...
class PainelFormularios(BasePanel):
    ...
    def create_widgets(self):
        ...
        # MODIFICADO: Usando estilo semântico do ttkbootstrap, removida configuração manual de estilo
        action_button = ttk.Button(self, text="Enviar Dados", command=self.show_form_data, style='success.TButton')
