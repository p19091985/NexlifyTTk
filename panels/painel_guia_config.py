...
class PainelGuiaConfig(BasePanel):
    """
    Controller e View unificados para o painel que exibe o guia de configuração.
    """
    ...
    def create_widgets(self):
        ...
        text_area.tag_configure("h1", font=(header_font_family, 16, "bold"), spacing1=20, spacing3=10,
                                foreground="#003366")
        text_area.tag_configure("h2", font=(subheader_font_family, 13, "bold"), spacing1=15, spacing3=8,
                                foreground="#005a9e")
        ...
        text_area.tag_configure("note", lmargin1=20, lmargin2=20, foreground="#555555", font=("Segoe UI", 9, "italic"),
                                spacing3=8)
        ...
        text_area.insert(tk.END,
                         "Esta aplicação foi desenvolvida com flexibilidade. As flags de configuração, localizadas no arquivo ",
                         "body")
        ...
        text_area.insert(tk.END, "   ▪ ", "body")
        text_area.insert(tk.END, "True:", "bold")
        text_area.insert(tk.END, " (Produção) Exige que o usuário se autentique. Permissões de acesso são aplicadas. ",
                         "body")
        ...
        text_area.insert(tk.END, "True:", "bold")
        text_area.insert(tk.END,
                         " (Setup Inicial / Testes) Se o arquivo SQLite estiver ausente ou vazio, cria as tabelas e dados iniciais do script ",
                         "body")
        ...
        text_area.insert(tk.END, "True:", "bold")
        text_area.insert(tk.END,
                         " (Produção / Debug Centralizado) Saídas do console (`print`, erros) são redirecionadas para os arquivos de log rotativos em ",
                         "body")
