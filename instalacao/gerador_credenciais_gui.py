...
class CredentialToolApp(tk.Tk):
    ...
    def _create_ini_tab(self, parent):
        ...
        ttk.Button(input_frame, text="Gerar Credenciais", command=self._generate_ini_creds, style="Success.TButton").grid(
            row=3, column=0, columnspan=2, pady=10, sticky="ew", ipady=5)
...
A aplicação (Desktop/Tkinter) precisa de uma "chave" para "abrir a porta" do banco de dados (PostgreSQL, MariaDB, etc.). # 
