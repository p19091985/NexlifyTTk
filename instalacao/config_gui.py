...
try:  
    ...
    messagebox.showerror("Erro Crítico", f"Não foi possível localizar o arquivo 'config.py' na pasta raiz do projeto ({project_root}). Verifique a estrutura de pastas.")  
    sys.exit(1)  
...
class ConfigApp(tk.Tk):
    ...
    def _create_widgets(self):                        
        ...
        ttk.Label(main_frame, text="Configurações Principais (config.py)", style="Header.TLabel").pack(pady=(0, 15), anchor="w")
        ...
        self.save_button = ttk.Button(main_frame, text="Salvar Configurações", command=self._save_settings, style="Success.TButton")
